...
public class RC4 {
    ...
    */
    ...
    public static void main(String args[]){
        String key = "54645asdkgjao7af09a^(8f9sda4=";
        for(int i = 1; i < 101; i++){
            String content = "abc" + i;
            String encrypt = RC4.encryptToString(content, key);
            String decrypt = RC4.decrypt(encrypt, key);
            if(!content.equals(decrypt)){
                System.out.println("加密失败, content=" + content);
            }
        }
    }
}
