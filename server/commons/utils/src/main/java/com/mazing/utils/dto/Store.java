...
public class Store implements Serializable {
	...
	private static final long serialVersionUID = 8055470730543779450L;
	...
	/** 门店状态；1-正常营业; 2-休业; 3-结业; 4-审核中(筹备中); 5-即将开业、 20：冻结（不展示、无法下单等）可结算、21：冻结（不展示、无法下单等）不可结算；；；20以内的状态（不含）门店自行维护，其他状态由平台管理。 */
	 ...
	 * key为1~7分别表示星期天~星期六，内层的int[]为长度2的数组表示：起、止时间的分钟数；（例如11:00-14:00，记录为[660 840]）
	 */
