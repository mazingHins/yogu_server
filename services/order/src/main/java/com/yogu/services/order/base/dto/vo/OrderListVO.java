...
public class OrderListVO implements Serializable{
	...
	/** 订单状态：10-未付款；15-已付款；20-已接单；25-配送中； 45-申请退款；50-退款中； */
	private short status; // add by jack 2016/4/14 用户微信h5查看订单详情

	/** 订单备注 */
	private String remark;// add by jack 2016/4/14 用户微信h5查看订单详情
