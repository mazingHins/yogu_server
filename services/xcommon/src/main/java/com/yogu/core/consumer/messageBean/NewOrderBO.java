 ...
 * @author felix
 */
public class NewOrderBO implements Serializable {
	...
	NewOrderBO(String uids, long orderNo, boolean inServiceRange, long storeId, int serviceTime, long orderFee, long payNo, long goodsFee, long deliveryFee,
			short payType, long couponId, long uid) {
		this.uids = uids;
	 ...
	 */
	public static NewOrderBO.Builder builder() {
		return new Builder();
	}
	...
	public static class Builder {
		 ...
		 * @return
		 */
		public NewOrderBO build() {
			return new NewOrderBO(uids, orderNo, inServiceRange, storeId, serviceTime, orderFee, payNo, goodsFee, deliveryFee, payType, couponId, uid);
		}
		 ...
		 */
		public void request() {
			CommandMQProducer.get().sendJSON(BussinessType.NEW_ORDER,
					new NewOrderBO(uids, orderNo, inServiceRange, storeId, serviceTime, orderFee, payNo, goodsFee, deliveryFee, payType, couponId, uid));
		}
	}
