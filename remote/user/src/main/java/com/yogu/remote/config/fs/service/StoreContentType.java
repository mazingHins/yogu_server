...
/**
 * 记录 .x 后缀 域 Content-Type 对应关系
 * 
 * @author jfan 2016年7月21日 下午6:11:08
 */
public class StoreContentType {
	...
	static {
		...
		map.put(".dwf", "Model/vnd.dwf");// --map.put(".dwf", "application/x-dwf");
		...
		map.put(".eps", "application/x-ps");// --map.put(".eps", "application/postscript");
		...
		map.put(".ico", "image/x-icon"); // --map.put(".ico", "application/x-ico");
		...
		map.put(".jpe", "image/jpeg"); // --map.put(".jpe", "application/x-jpe");
		map.put(".jpeg", "image/jpeg");
		map.put(".jpg", "image/jpeg"); // --map.put(".jpg", "application/x-jpg");
		...
		map.put(".mdb", "application/x-mdb");// --map.put(".mdb", "application/msaccess");
		...
		map.put(".rtf", "application/x-rtf");// --map.put(".rtf", "application/msword");
		...
		map.put(".tif", "image/tiff"); // --map.put(".tif", "application/x-tif");
		...
		map.put(".vsd", "application/x-vsd");// --map.put(".vsd", "application/vnd.visio");
		map.put(".vss", "application/vnd.visio");
		map.put(".vst", "application/x-vst");// --map.put(".vst", "application/vnd.visio");
		...
		map.put(".xls", "application/x-xls");// -- map.put(".xls", "application/vnd.ms-excel");
	...
	public static String getContentType(String filename) {
		...
		String type = null;
		if (pos > 0) {
			String lowerName = filename.substring(pos).toLowerCase();
			/*
			if (".jpeg".equals(lowerName) || ".jpg".equals(lowerName)) {
				type = "image/jpeg";
			} else if (".png".equals(lowerName)) {
				type = "image/png";
			} else if (".bmp".equals(lowerName)) {
				type = "image/bmp";
			}
			*/
			type = map.get(lowerName);
		}
		if (type == null) {
