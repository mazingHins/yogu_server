...
import com.mazing.test.core.utils.DigestUtil;
import com.mazing.test.core.utils.SignUtils;
...
public abstract class ApiReq<T> {
	...
	public static String aver = "1.3.5.90";
	public static String sver = "8.3";
	public static String cityCode = "020";//"GZS";
	...
	public ApiReq<T> setLang(String lang) {
		getparams.put("lang", new String[] { lang });
		return this;
	}
	...
	public KeyValue<String, String> login() {
		//s 接口登录
//		return login("86", "12012345646", "abcd1234");
	...
	public ApiReq<T> clearUserToken() {
		postparams.remove("ut");
		getparams.remove("ut");
...
//		System.out.println("请求地址（encode）：" + urlEncode.toString());
