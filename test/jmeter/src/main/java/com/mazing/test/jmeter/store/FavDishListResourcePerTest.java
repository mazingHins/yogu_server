 ...
 */
public class FavDishListResourcePerTest extends AbstractJavaPerf {
	...
	public FavDishListResourcePerTest() {
		super(true, true);
		collectDishKey();
		collectStoreId();
	}
	...
	protected void initial() {
		req = new HttpRequestBuild().build(storeHost + "/a/v1/fav/dish/list");
	}
