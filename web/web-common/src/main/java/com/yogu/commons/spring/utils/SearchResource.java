package com.yogu.commons.spring.utils;
					...
					if (meta != null) {
						try {
							...
							if (classZ.isAnnotationPresent(Menu.class)) {
								...
								if (classPath != null && classPath.value() != null && classPath.value().length > 0) {
									// 前后加上路径分隔符  /
									classPathValue = classPath.value()[0];
								...
								for (Method method : methods) {
									if (method
										...
										if (classPath != null && path != null && path.value() != null && path.value().length > 0) {
