				...
				<div class="col-xs-12">
					<div class="box">
						...
						<div class="box-body">
							<div class="row">
								<div class="col-sm-12">
									<p class="text-left">订单状态有：未付款、已支付、买家确认收货、买家已评论、申请退款中、系统退款中、退款成功、拒绝退款、已取消</p>
									<p class="text-left">下单渠道有：iphone、android、mobile(H5)</p>
									<p class="text-left">只展示米星付订单</p>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-12">
									<table id="listTable" class="table table-bordered table-hover">
										...
										<script id="listTableTpl" type="text/html">
											...
											<tr>
												...
												<td>
													<a target="_blank" href="/admin/order/mazingPay/orderDetail.xhtm?orderNo={{value.orderNoStr}}">{{value.orderNoStr}}</a><br/>
...
<script type="text/javascript">
	function search(keyword) {
		if (keyword.length > 0 && isNaN(keyword)) {
				...
				if (json.success) {
					...
					if (storeList.length == 1) {
						$('#listTable').artPaginate({
							// 获取数据的地址
							url: "/admin/order/mazingPay/queryByStoreId",
							// 显示页码的位置
			...
			$('#listTable').artPaginate({
				// 获取数据的地址
				url: "/admin/order/mazingPay/query",
				// 显示页码的位置
				paginator: 'listPaginator',
				// 模版ID
				tpl: 'listTableTpl',
