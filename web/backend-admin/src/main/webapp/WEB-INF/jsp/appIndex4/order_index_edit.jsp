					...
					<div id="listDiv" class="col-xs-12">
						<div class="box" id="block">
							...
							<div id="listAdverItem" class="box-body">
													...
													<div class="form-group">
														...
														<div class="col-md-3">
															<select id="target_{{i}}" name="target" class="form-control">
																<option value="newsBlock" {{if adverItem.target === 'newsBlock'}}selected{{/if}}>资讯</option>
																<option value="store" {{if adverItem.target === 'store'}}selected{{/if}}>餐厅</option>
																<option value="h5" {{if adverItem.target === 'h5'}}selected{{/if}}>h5</option>
															</select>
														</div>
													</div>
												...
												<div id="targerDiv" class="form-group">
													...
													<div class="form-group">
														<label class="col-md-2 control-label">数据项ID<span
															style="color: red;">*</span></label>
														<div class="col-md-2">
															<input id="targetId_{{i}}" class="form-control" name="targetId" placeholder="数据项ID默认0" value="{{adverItem.targetId}}">
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-md-3">
															<input id="name_{{i}}" value="{{adverItem.name}}" class="form-control" name="name" placeholder="请输入项显示的名称">
														</div>
														<div class="col-md-3">
													...
													<div class="form-group">
														...
														<div class="col-md-3">
															<input id="description_{{i}}" value="{{adverItem.description}}" class="form-control" name="description" placeholder="请输入项显示的简介内容">
														</div>
														<div class="col-md-3">
															<p class="text-red">不填默认取关联的数据项ID相关内容</p>
														</div>
													...
													<div class="form-group">
														...
														<div class="col-md-3">
															<input id="url_{{i}}" value="{{adverItem.url}}" class="form-control" name="url" placeholder="请输入项跳转的url">
														</div>
														<div class="col-md-3">
															<p class="text-red">不填默认取关联的数据项ID相关内容</p>
														</div>
													...
													<div class="form-group">
														<label class="col-md-2 control-label">项图片<span
															style="color: red;">*</span></label>
														<div class="col-md-3">
															<img id="imgPreview_{{i}}" width="200" src="https://img.mazing.com/{{adverItem.img}}"/> 
															<input id="picInput_{{i}}" num="{{i}}" callback="previewImg" type="file" value="更换图片..."> 
															<input id="img_{{i}}" value="{{adverItem.img}}" name="img" type="hidden" />
														</div>
														<div class="col-md-3">
													...
													<div class="form-group">
														...
														<div class="col-md-3">
															<select id="canShare_{{i}}" name="canShare" class="form-control">
																<option value="0" {{if adverItem.canShare != 1}}selected{{/if}}>否</option>
																<option value="1" {{if adverItem.canShare == 1}}selected{{/if}}>是</option>
															</select>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-md-3">
															<img id="shareImgPreview_{{i}}" width="200"{{if adverItem.canShare != 1}}src=""{{/if}}{{if adverItem.canShare == 1}} src="https://img.mazing.com/{{adverItem.shareImg}}{{/if}}"/> 
															<input id="shareImgInput_{{i}}" num="{{i}}" callback="previewShareImg" type="file" value="更换图片..."> 
															<input id="shareImg_{{i}}" value="{{adverItem.shareImg}}" name="shareImg" type="hidden" />
														</div>
														<div class="col-md-3">
													...
													<div class="form-group">
														...
														<div class="col-md-3">
															<input id="shareTitle_{{i}}" value="{{adverItem.shareTitle}}" class="form-control" name="shareTitle" placeholder="分享数据项给朋友显示的标题">
														</div>
														<div class="col-md-3">
															<p class="text-red">能分享时候必填</p>
														</div>
													...
													<div class="form-group">
														...
														<div class="col-md-3">
															<input id="shareTimelineTitle_{{i}}" value="{{adverItem.shareTimelineTitle}}" class="form-control" name="shareTimelineTitle" placeholder="分享数据项到朋友圈显示的标题">
														</div>
														<div class="col-md-3">
															<p class="text-red">能分享时候必填</p>
														</div>
													...
													<div class="form-group">
														...
														<div class="col-md-3">
															<input id="shareContent_{{i}}" value="{{adverItem.shareContent}}" class="form-control" name="shareContent" placeholder="分享专题显示的内容">
														</div>
														<div class="col-md-3">
															<p class="text-red">能分享时候必填</p>
														</div>
								...
								<script id="addAdverItemTpl" type="text/html">
								<table class="table table-bordered table-hover" id="adverItem_{{i}}">
									<tr>
							...
							<div id="addAdverItem" class="box-body">
	...
	<script type="text/javascript">
		...
		function loadIndexBlock(){
			...
			requestNode('/order/admin/getindex?vid=${vid}', 'get', {}, function(data){
				var html = template('adverItem', {list:data[0].items});
				// 模板要一起初始化,不然后面调用会报错
				template('addAdverItemTpl',{i:0});
				document.getElementById('listAdverItem').innerHTML = html;
				block_i = data[0].items.length + 1;
				
				$('#targetParams_1000').val(data[1].itemIds.join(','));
			});
		}
		
		function addAdverItem(){
			var html = template('addAdverItemTpl', {i:block_i});
...
//------------
		...
		function editOrderIndex(){
			...
			var cityCode = '${city.code}';
			var langCode = '${lang.code}';
			requestNode('/order/admin/editindex', 'post', {vid, blockArray:JSON.stringify(blockArray)}, function(data){
