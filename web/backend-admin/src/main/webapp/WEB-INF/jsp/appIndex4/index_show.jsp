							...
							<div class="box-body">
								<table class="table table-bordered table-hover">
									...
									<tr>
										<th>块元素类型</th>
										<td>
										{{if block.type == 'newsBlock'}}资讯{{/if}}
										{{if block.type == 'store'}}餐厅{{/if}}
										{{if block.type == 'event'}}活动{{/if}}
										</td>
									</tr>
									<tr>
										<th>动作</th>
										<td>
										{{if block.action == 'newsIndex'}}推荐列表(资讯){{/if}}
										{{if block.action == 'orderIndex'}}订餐首页{{/if}}
										{{if block.action == 'event'}}活动{{/if}}
										</td>
									</tr>
									<tr>
										<th>置顶ID</th>
										<td>
											{{block.itemIds | stringArrayJoin}}
										</td>
									</tr>
								</table>
								{{if block.type == 'newsBlock'}}
									...
									<table class="table table-bordered table-hover">
										...
										<tr>
											<th>图片</th>
											<td><img height='100' src='https://img.mazing.com/{{item.img}}'/></td>
										</tr>
									</table>
									{{/each}}
								{{/if}}
								{{if block.type == 'store'}}
									...
									<table class="table table-bordered table-hover">
										...
										<tr>
											<th>LOGO</th>
											<td><img height='100' src='https://img.mazing.com/{{item.logoPath}}'/></td>
										</tr>
									</table>
									{{/each}}
								{{/if}}
								{{if block.type == 'event'}}
									...
									<table class="table table-bordered table-hover">
										<tr>
											...
											<td width='100'>{{item.eventId}}</td>
											<th width='100'>活动名称</th>
											<td width='100'>{{item.eventName}}</td>
										...
										<tr>
											...
											<td width='100'><img height='100' src='https://img.mazing.com/{{item.coverImg}}'/></td>
											<th colspan='5'></th>
										</tr>
									</table>
									{{/each}}
